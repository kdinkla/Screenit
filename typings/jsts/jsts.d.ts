...
declare module jsts {
    ...
    export module geom {
        ...
        export class GeometryFactory {
            ...
            createPoint(c: Coordinate): Point;
            createMultiPoint(cs: Coordinate[]): MultiPoint;
            createLineString(cs: Coordinate[]): LineString;
            createLinearRing(cs: Coordinate[]): LineString;
            createMultiLineString(lSs: LineString[]): MultiLineString;
            createPolygon(hull: LinearRing, holes: LinearRing[]);
        }
    ...
    export module operation {
        ...
        export module union {
            ...
            export class CascadedPolygonUnion {

                constructor(polygons: geom.Geometry[]);
    ...
    export module simplify {
        ...
        export class DouglasPeuckerSimplifier {
            constructor(geometry: geom.Geometry);
            getResultGeometry(): geom.Geometry;
            setDistanceTolerance(tolerance: number);
            static simplify(geom: geom.Geometry, tolerance: number): geom.Geometry;
        }
