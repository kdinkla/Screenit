...
define(["require", "exports", 'bacon', './model', './core/dataprovider', './visualization/overview'], function (require, exports, bacon, model_1, dataprovider_1, overview_1) {
    ...
    if (sessionPart.length === 0) {
        ...
        var overView = new overview_1.OverView();
        // Current state of the application.
        var interactionState = new model_1.InteractionState();
        ...
        var enrichedStates = interactionStates
            .throttle(100)
            .map(function (s) { return new model_1.EnrichedState(s); });
        var proxyService = new dataprovider_1.ProxyService(serverPath, enrichedStates);
        ...
        overView.event.onValue(function (event) {
            ...
            var newState = overView.model ? overView.model.cloneInteractionState() : new model_1.EnrichedState(interactionState);
        ...
        Promise
            ...
            try {
                var loadedState = model_1.InteractionState.fromJSON(v);
